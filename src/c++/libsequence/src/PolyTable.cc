...
{ 
  ...
  */
   ...
   */
  {
    ...
    unsigned nsam = beg->second.length(),i=0,j=0;
  ...
  */
  ...
  /*!
    ...
    \param strictInfSites if \c true, throw out all sites with > 2 character states (including outgroup!)
