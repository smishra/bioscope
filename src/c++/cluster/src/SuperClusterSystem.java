...
class SuperClusterSystem implements Runnable{
    ...
    SuperClusterSystem (String  filename, Vector chromosomes, String session, String cache, String organism, String Name)
    {
	    ...
	    raf.seek(raf.length());
            ...
            try
			    ...
			    while ((line = in.readLine()) != null)
                        ...
                        {
                            System.out.println ("SuperClusterExecute.java : IO error occurred " + FileContent + "<p>") ;
                        }

                }
	    catch (FileNotFoundException e)
                {
                    System.out.println ("SuperClusterExecute.java : File not found " + FileContent + "<p>") ;
                }
	    raf.close() ;
        }
	catch (IOException e) {
	...
	try
		...
		if (Wait)
			...
			try
			    ...
			    {
				System.out.println ("SuperClusterExecute.java : while executing " + Command + "  <br>") ;
			    }
		    }
	    }
	catch (IOException e)
	    {
		System.out.println ("SuperClusterExecute.java : Command " + Command + "Failed  <br>") ;
	    }
