class SuperCluster implements Runnable {
    ...
    SuperCluster (String filename, String chromosome, String session, String cache)
    {
    ...
    void SetParameters (String filename, String chromosome, String session, String cache)
    {
	this.filename = filename ;
	this.chromosome = chromosome ;
	this.session = session ;
