 ...
 * Since MemConfig can take any XML file as input file, it shouldn't hardcode to expect 16 elements.
...
class MemConfigHandlers : public HandlerBase
{
public :
    // -----------------------------------------------------------------------
    //  Constructors
