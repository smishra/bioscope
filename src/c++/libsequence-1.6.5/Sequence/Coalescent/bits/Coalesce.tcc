...
namespace Sequence
{
  ...
  /*!
    ...
    \param ttl_snam The total sample size being simuled (the sum of sample sizes over all demes)
  ...
  */
  {
    return pick2_in_deme_details(uni,sample,ttl_nsam,deme_nsam,deme);
  }
#endif
