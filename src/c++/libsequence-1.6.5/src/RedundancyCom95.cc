...
namespace Sequence
{
  ...
  struct RedundancyCom95impl
  {
    ...
    void FillLValues ();
    void codonPrecondition(const std::string & codon) throw (Sequence::SeqException);
  };
  ...
  void RedundancyCom95impl::codonPrecondition(const std::string & codon) throw (Sequence::SeqException)
  /*!
  ...
  */
  ...
  double
  RedundancyCom95::FirstNon (const std::string & codon) const throw (Sequence::SeqException)
  /*!
  ...
  */
  ...
  double
  RedundancyCom95::First2S (const std::string & codon) const throw (Sequence::SeqException)
  /*!
  ...
  */
  ...
  double
  RedundancyCom95::First2V (const std::string & codon) const throw (Sequence::SeqException)
  /*!
  ...
  */
  ...
  double
  RedundancyCom95::ThirdNon (const std::string & codon) const throw (Sequence::SeqException)
  /*!
  ...
  */
  ...
  double
  RedundancyCom95::ThirdFour (const std::string & codon) const throw (Sequence::SeqException)
  /*!
  ...
  */
  ...
  double
  RedundancyCom95::Third2S (const std::string & codon) const throw (Sequence::SeqException)
  /*!
  ...
  */
  ...
  double
  RedundancyCom95::Third2V (const std::string & codon) const throw (Sequence::SeqException)
  /*!
  ...
  */
  ...
  double
  RedundancyCom95::L0_vals (const std::string & codon) const throw (Sequence::SeqException)
  /*!
  ...
  */
  ...
  double
  RedundancyCom95::L2S_vals (const std::string & codon) const throw (Sequence::SeqException)
  /*!
  ...
  */
  ...
  double
  RedundancyCom95::L2V_vals (const std::string & codon) const throw (Sequence::SeqException)
  /*!
  ...
  */
  ...
  double
  RedundancyCom95::L4_vals (const std::string & codon) const throw (Sequence::SeqException)
  /*!
