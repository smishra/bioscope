...
class Results  {
  ...
  void PrintResults (EnhancerParam &, int, int, Sequence::Fasta &, string &, int, fstream &, string &) ;
  void OutputResults (EnhancerParam &, Sequence::Fasta &, vector <Annotation *> &, Exon &) ;
  private :
