...
//        try
//        {
//            porterstemfilter = new PorterStemFilter(new StopFilter(new LowerCaseTokenizer(new FileReader("")), stopWords));
//        }
//        catch(FileNotFoundException filenotfoundexception) { }
    }

    private static final Set stopWords = null;
