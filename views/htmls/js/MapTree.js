function MapTree() {
  var mapTree = new TreeNode("Maps", null);
...
function TreeNode(name, parentNode) {
    ...
    this.expandImageURI = window.contextPath + "/pages/images/menu_expand.gif";
    this.collapseImageURI = window.contextPath + "/pages/images/menu_collapse.gif";
    this.collapsed = true;
